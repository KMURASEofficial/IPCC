...
#define REDUCE
#define MULTIGRAPH 1 // 0 is single graph, 1 is multigraph
#define K1 3
#define K2 4
#define K  (K1+K2)
...
#define REDUCE_DUP
#define POLY_SHUFFLE
#define DEBUG 1 // 1(table forms) or 2(polynomial forms) or 3(for tex)
#define Q 2147483648 // message space
// #define Q 33292 // message space
#define UI 0
...
#define DEPEND 1
#define NOTDEPEND 0
#define TERM (1<<(2*K+1))*2 //* 2 // 2배 여유롭게
